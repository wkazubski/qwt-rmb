...
namespace
{
    ...
    {
      public:
        Rubberband( QwtPicker2* picker, QWidget* parent )
    ...
    {
      public:
        Tracker( QwtPicker2* picker, QWidget* parent )
            : QwtWidgetOverlay( parent )
            , m_picker( picker )
        {
            setMaskMode( QwtWidgetOverlay::MaskHint );
 ...
 */
QRegion QwtPicker2::trackerMask() const
{
...
/*! 
   ...
   \sa trackerPosition()
 */
QRect QwtPicker2::trackerRect( const QSize& size ) const
{

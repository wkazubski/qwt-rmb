...
/*!
   ...
   QwtPlotPicker is a QwtPicker2 tailored for selections on
...
class QWT_EXPORT QwtPlotPicker2 : public QwtPicker2
{
  ...
  public:
    ...
    explicit QwtPlotPicker2( QwtAxisId xAxisId, QwtAxisId yAxisId, QWidget* );

    explicit QwtPlotPicker2( QwtAxisId xAxisId, QwtAxisId yAxisId,
  ...
  Q_SIGNALS:
    ...
    /*!
       A signal emitted in case of QwtPicker2Machine::PointSelection.
       \param pos Selected point
     */
    void selected( const QPointF& pos );

    /*!
       A signal emitted in case of QwtPicker2Machine::RectSelection.

...
/*!
  ...
  \sa eventFilter(), widgetMousePressEvent(), widgetMouseReleaseEvent(),
      ...
      widgetWheelEvent(), widgetKeyPressEvent(), widgetKeyReleaseEvent()
*/
void QwtPicker2::widgetEnterEvent( QEvent *event )
{
    transition( event );
}
...
/*!
  ...
  \sa eventFilter(), widgetMousePressEvent(), widgetMouseReleaseEvent(),
      ...
      widgetWheelEvent(), widgetKeyPressEvent(), widgetKeyReleaseEvent()
*/
void QwtPicker2::widgetLeaveEvent( QEvent *event )
{
    transition( event );
...
/*!
  ...
  \sa eventFilter(), widgetMousePressEvent(),
      ...
      widgetWheelEvent(), widgetKeyPressEvent(), widgetKeyReleaseEvent()
*/
void QwtPicker2::widgetMouseReleaseEvent( QMouseEvent *mouseEvent )
{
    transition( mouseEvent );
}
...
/*!
  ...
  \sa eventFilter(), widgetMousePressEvent(), widgetMouseReleaseEvent(),
      ...
      widgetWheelEvent(), widgetKeyPressEvent(), widgetKeyReleaseEvent()
*/
void QwtPicker2::widgetMouseDoubleClickEvent( QMouseEvent *mouseEvent )
{
    transition( mouseEvent );
}
...
*/
void QwtPicker2::widgetWheelEvent( QWheelEvent *wheelEvent )
{
...
*/
void QwtPicker2::widgetKeyPressEvent( QKeyEvent *keyEvent )
{
    int dx = 0;
    int dy = 0;
...
*/
void QwtPicker2::widgetKeyReleaseEvent( QKeyEvent *keyEvent )
{
    transition( keyEvent );
}
...
/*!
  ...
  \param event Event
*/
void QwtPicker2::transition( const QEvent *event )
{
    if ( !d_data->stateMachine )
        return;

    const QList<QwtPicker2Machine::Command> commandList =
    ...
    for ( int i = 0; i < commandList.count(); i++ )
    {
        ...
        {
            case QwtPicker2Machine::Begin:
            {
                begin();
                break;
            }
            case QwtPicker2Machine::Append:
            {
                append( pos );
                break;
            }
            case QwtPicker2Machine::Move:
            {
                move( pos );
                break;
            }
            case QwtPicker2Machine::Remove:
            {
                remove();
                break;
            }
            case QwtPicker2Machine::End:
            {
                end();
                break;
            }
...
*/
void QwtPicker2::append( const QPoint &pos )
{
    if ( d_data->isActive )
    {
...
*/
void QwtPicker2::move( const QPoint &pos )
{
...
*/
bool QwtPicker2::accept( QPolygon &selection ) const
{
    Q_UNUSED( selection );
    return true;
}
...
*/
bool QwtPicker2::isActive() const
{
...
*/
const QPolygon &QwtPicker2::pickedPoints() const
{
...
*/
void QwtPicker2::stretchSelection( const QSize &oldSize, const QSize &newSize )
{
    if ( oldSize.isEmpty() )
    {
...
void QwtPicker2::setMouseTracking( bool enable )
{
...
*/
QPainterPath QwtPicker2::pickArea() const
{
    QPainterPath path;
...
void QwtPicker2::updateDisplay()
{
    ...
    QPointer< QwtPicker2Rubberband > &rw = d_data->rubberBandOverlay;
    if ( showRubberband )
    {
        if ( rw.isNull() )
        {
            rw = new QwtPicker2Rubberband( this, NULL ); // NULL -> no extra event filter
    ...
    QPointer< QwtPicker2Tracker > &tw = d_data->trackerOverlay;
    if ( showTracker )
    {
        if ( tw.isNull() )
        {
            tw = new QwtPicker2Tracker( this, NULL ); // NULL -> no extra event filter
...
const QwtWidgetOverlay *QwtPicker2::rubberBandOverlay() const
{
    return d_data->rubberBandOverlay;
}

//! \return Overlay displaying the tracker text
const QwtWidgetOverlay *QwtPicker2::trackerOverlay() const
{

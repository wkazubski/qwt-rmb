...
class QwtPicker2::PickerWidget: public QWidget
{
public:
    enum Type
    {
    ...
    PickerWidget( QwtPicker2 *, QWidget *, Type );
    void updateMask();
...
QwtPicker2::PickerWidget::PickerWidget(
        QwtPicker2 *picker, QWidget *parent, Type type ):
    QWidget( parent ),
    d_hasTextMask( false ),
    d_picker( picker ),
    d_type( type )
...
void QwtPicker2::PickerWidget::updateMask()
{
    QRegion mask;
...
void QwtPicker2::PickerWidget::paintEvent( QPaintEvent *e )
{
...
*/
QRect QwtPicker2::pickRect() const
{
...
const QWidget *QwtPicker2::rubberBandWidget() const
{
    return d_data->rubberBandWidget;
}

//! \return Widget displaying the tracker text
const QWidget *QwtPicker2::trackerWidget() const
{
